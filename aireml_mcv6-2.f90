...
subroutine aireml_mcv_m_h2 (mbin,yidx,yv,rn,rnm,trn,pedn,ttn,tn,fnm,tfn,mn,fl4,fl5,fl11,fl12,fl24,xmm,nit,conv,thn)        
...
do i=1,ttn
  if (sub_tn(i).ne.rnm(i)) then
    print*,'# E variable and # records not matched',i
    pause
  end if
end do
